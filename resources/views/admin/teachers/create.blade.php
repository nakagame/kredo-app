...
@section('title', 'Admin: Create Teacher')
...
@section('content')
    ...
    <h1 class="text-secondary fw-light mb-3">Create Teacher</h1>

    <div class="bg-white">
        <form action="{{ route('admin.teachers.store') }}" method="POST" class="w-50 p-5">
            @csrf
            ...
            <button type="submit" class="btn btn-info small">
